...
const DepartureFlightList = ({
  ...
  return (
    <div className="mb-6 p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
      <h2 className="text-4xl font-extrabold dark:text-white mb-4">{title}</h2>
      {loading && (
      ...
      {!loading && flights.length > 0 && (
        <ul>
          {flights.map((flight) => (
            <li
              key={flight.id}
              className="mb-2 flex justify-between items-center block  p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700"
            >
              <div className="flex-grow">
                ...
                <p className="font-normal text-gray-700 dark:text-gray-400">
                  ...
                  <br />
                  <span className="text-sm">
                    Flight Duration: {flight.flightLength}
                  </span>
                  <br />
